...
namespace StarryNight.Tests.AppService.TagTargets
{
    public class TagTargetAppService_Tests : StarryNightTestBase
    {
        private readonly ITagAppService tagAppService;
        private readonly ITagTargetAppService tagTargetAppService;

        private readonly IMetaEntityManager metaEntityManager;

        private readonly ITagTargetRepository tagTargetRepository;

        public TagTargetAppService_Tests()
        {
            tagAppService = Resolve<ITagAppService>();
            tagTargetAppService = Resolve<ITagTargetAppService>();
